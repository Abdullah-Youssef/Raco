...
import 'package:raco_ksa/component/base_scaffold_body.dart';
...
import 'package:raco_ksa/screens/booking/component/confirm_booking_dialog.dart';
import 'package:raco_ksa/screens/map/map_screen.dart';
import 'package:raco_ksa/screens/service/package/package_info_bottom_sheet.dart';
                          ...
                          (widget.data.serviceDetail!.isSlot == 1 &&
                              (widget.data.serviceDetail!.bookingSlot == null ||
                                  widget.data.serviceDetail!.bookingSlot
                                      .validate()
                                      .isEmpty))) {
                        toast(language.lblEnterPhnNumber);
                      } else {
          ...
          Column(
            ...
            children: [
              Text(widget.data.serviceDetail!.name.validate(),
                  style: boldTextStyle()),
              4.height,
              Text('${widget.data.serviceDetail!.categoryName.validate()}',

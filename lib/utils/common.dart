...
import 'package:raco_ksa/component/html_widget.dart';
import 'package:raco_ksa/component/location_service_dialog.dart';
import 'package:raco_ksa/component/new_update_dialog.dart';
...
import 'package:raco_ksa/services/location_service.dart';
import 'package:raco_ksa/utils/colors.dart';
import 'package:raco_ksa/utils/images.dart';
import 'package:raco_ksa/utils/permissions.dart';
...
Future<FirebaseRemoteConfig> setupFirebaseRemoteConfig() async {
  ...
  if (remoteConfig.getString(USER_CHANGE_LOG).validate().isNotEmpty) {
    ...
    await setValue(IN_MAINTENANCE_MODE,
        remoteConfigDataModel.inMaintenanceMode.validate());
